...
public class Car extends JDialog {
	...
	public Car(int index,Param param) {
		...
		contentPane.add(lblMincom, gbc_lblMincom);
				...
				txtInitposx.setText(Integer.toString((5000*(Integer.parseInt(param.getNb_car())-index-1))));
				...
				txtInitV.setText(Integer.toString(2000+(1000*index)));
