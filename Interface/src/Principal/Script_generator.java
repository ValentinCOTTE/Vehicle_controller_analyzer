...
public class Script_generator {
	...
	public Script_generator(Param_set param){
		...
		try {
			...
			if(nb_car==5){
				for(initV[0]=param.getCar_list().get(0).getInitV();initV[0]<=param.getCar_list().get(0).getLIMIT_initV();initV[0]+=param.getCar_list().get(0).getSTEP_initV()){
					for(initV[1]=param.getCar_list().get(1).getInitV();initV[1]<=param.getCar_list().get(1).getLIMIT_initV();initV[1]+=param.getCar_list().get(1).getSTEP_initV()){
						for(initV[2]=param.getCar_list().get(2).getInitV();initV[2]<=param.getCar_list().get(2).getLIMIT_initV();initV[2]+=param.getCar_list().get(2).getSTEP_initV()){
							for(initV[3]=param.getCar_list().get(3).getInitV();initV[3]<=param.getCar_list().get(3).getLIMIT_initV();initV[3]+=param.getCar_list().get(3).getSTEP_initV()){
								for(initV[4]=param.getCar_list().get(4).getInitV();initV[4]<=param.getCar_list().get(4).getLIMIT_initV();initV[4]+=param.getCar_list().get(4).getSTEP_initV()){
									for(initA[0]=param.getCar_list().get(0).getInitA();initA[0]<=param.getCar_list().get(0).getLIMIT_initA();initA[0]+=param.getCar_list().get(0).getSTEP_initA()){
										for(initA[1]=param.getCar_list().get(1).getInitA();initA[1]<=param.getCar_list().get(1).getLIMIT_initA();initA[1]+=param.getCar_list().get(1).getSTEP_initA()){
											for(initA[2]=param.getCar_list().get(2).getInitA();initA[2]<=param.getCar_list().get(2).getLIMIT_initA();initA[2]+=param.getCar_list().get(2).getSTEP_initA()){
												for(initA[3]=param.getCar_list().get(3).getInitA();initA[3]<=param.getCar_list().get(3).getLIMIT_initA();initA[3]+=param.getCar_list().get(3).getSTEP_initA()){
													for(initA[4]=param.getCar_list().get(4).getInitA();initA[4]<=param.getCar_list().get(4).getLIMIT_initA();initA[4]+=param.getCar_list().get(4).getSTEP_initA()){
														SCRIPT+=writeCycle();
													}
													initA[4]=param.getCar_list().get(4).getInitA();
												}
												initA[3]=param.getCar_list().get(3).getInitA();
											}
											initA[2]=param.getCar_list().get(2).getInitA();
								...
								initV[4]=param.getCar_list().get(4).getInitV();
							}
							initV[3]=param.getCar_list().get(3).getInitV();
						}
						initV[2]=param.getCar_list().get(2).getInitV();
				...
				for(initV[0]=param.getCar_list().get(0).getInitV();initV[0]<=param.getCar_list().get(0).getLIMIT_initV();initV[0]+=param.getCar_list().get(0).getSTEP_initV()){
					for(initV[1]=param.getCar_list().get(1).getInitV();initV[1]<=param.getCar_list().get(1).getLIMIT_initV();initV[1]+=param.getCar_list().get(1).getSTEP_initV()){
						for(initV[2]=param.getCar_list().get(2).getInitV();initV[2]<=param.getCar_list().get(2).getLIMIT_initV();initV[2]+=param.getCar_list().get(2).getSTEP_initV()){
							for(initV[3]=param.getCar_list().get(3).getInitV();initV[3]<=param.getCar_list().get(3).getLIMIT_initV();initV[3]+=param.getCar_list().get(3).getSTEP_initV()){
								for(initV[4]=param.getCar_list().get(4).getInitV();initV[4]<=param.getCar_list().get(4).getLIMIT_initV();initV[4]+=param.getCar_list().get(4).getSTEP_initV()){
									for(initV[5]=param.getCar_list().get(5).getInitV();initV[5]<=param.getCar_list().get(5).getLIMIT_initV();initV[5]+=param.getCar_list().get(5).getSTEP_initV()){
										for(initA[0]=param.getCar_list().get(0).getInitA();initA[0]<=param.getCar_list().get(0).getLIMIT_initA();initA[0]+=param.getCar_list().get(0).getSTEP_initA()){
											for(initA[1]=param.getCar_list().get(1).getInitA();initA[1]<=param.getCar_list().get(1).getLIMIT_initA();initA[1]+=param.getCar_list().get(1).getSTEP_initA()){
												for(initA[2]=param.getCar_list().get(2).getInitA();initA[2]<=param.getCar_list().get(2).getLIMIT_initA();initA[2]+=param.getCar_list().get(2).getSTEP_initA()){
													for(initA[3]=param.getCar_list().get(3).getInitA();initA[3]<=param.getCar_list().get(3).getLIMIT_initA();initA[3]+=param.getCar_list().get(3).getSTEP_initA()){
														for(initA[4]=param.getCar_list().get(4).getInitA();initA[4]<=param.getCar_list().get(4).getLIMIT_initA();initA[4]+=param.getCar_list().get(4).getSTEP_initA()){
															for(initA[5]=param.getCar_list().get(5).getInitA();initA[5]<=param.getCar_list().get(5).getLIMIT_initA();initA[5]+=param.getCar_list().get(5).getSTEP_initA()){
																SCRIPT+=writeCycle();
															}
															initA[5]=param.getCar_list().get(5).getInitA();
														}
														initA[4]=param.getCar_list().get(4).getInitA();
													}
													initA[3]=param.getCar_list().get(3).getInitA();
									...
									initV[5]=param.getCar_list().get(5).getInitV();
								}
								initV[4]=param.getCar_list().get(4).getInitV();
							}
							initV[3]=param.getCar_list().get(3).getInitV();
					...
					for(initV[1]=param.getCar_list().get(1).getInitV();initV[1]<=param.getCar_list().get(1).getLIMIT_initV();initV[1]+=param.getCar_list().get(1).getSTEP_initV()){
						for(initV[2]=param.getCar_list().get(2).getInitV();initV[2]<=param.getCar_list().get(2).getLIMIT_initV();initV[2]+=param.getCar_list().get(2).getSTEP_initV()){
							for(initV[3]=param.getCar_list().get(3).getInitV();initV[3]<=param.getCar_list().get(3).getLIMIT_initV();initV[3]+=param.getCar_list().get(3).getSTEP_initV()){
								for(initV[4]=param.getCar_list().get(4).getInitV();initV[4]<=param.getCar_list().get(4).getLIMIT_initV();initV[4]+=param.getCar_list().get(4).getSTEP_initV()){
									for(initV[5]=param.getCar_list().get(5).getInitV();initV[5]<=param.getCar_list().get(5).getLIMIT_initV();initV[5]+=param.getCar_list().get(5).getSTEP_initV()){
										for(initV[6]=param.getCar_list().get(6).getInitV();initV[6]<=param.getCar_list().get(6).getLIMIT_initV();initV[6]+=param.getCar_list().get(6).getSTEP_initV()){
											for(initA[0]=param.getCar_list().get(0).getInitA();initA[0]<=param.getCar_list().get(0).getLIMIT_initA();initA[0]+=param.getCar_list().get(0).getSTEP_initA()){
												for(initA[1]=param.getCar_list().get(1).getInitA();initA[1]<=param.getCar_list().get(1).getLIMIT_initA();initA[1]+=param.getCar_list().get(1).getSTEP_initA()){
													for(initA[2]=param.getCar_list().get(2).getInitA();initA[2]<=param.getCar_list().get(2).getLIMIT_initA();initA[2]+=param.getCar_list().get(2).getSTEP_initA()){
														for(initA[3]=param.getCar_list().get(3).getInitA();initA[3]<=param.getCar_list().get(3).getLIMIT_initA();initA[3]+=param.getCar_list().get(3).getSTEP_initA()){
															for(initA[4]=param.getCar_list().get(4).getInitA();initA[4]<=param.getCar_list().get(4).getLIMIT_initA();initA[4]+=param.getCar_list().get(4).getSTEP_initA()){
																for(initA[5]=param.getCar_list().get(5).getInitA();initA[5]<=param.getCar_list().get(5).getLIMIT_initA();initA[5]+=param.getCar_list().get(5).getSTEP_initA()){
																	for(initA[6]=param.getCar_list().get(6).getInitA();initA[6]<=param.getCar_list().get(6).getLIMIT_initA();initA[6]+=param.getCar_list().get(6).getSTEP_initA()){
																		SCRIPT+=writeCycle();
																	}
																	initA[6]=param.getCar_list().get(6).getInitA();
																}
																initA[5]=param.getCar_list().get(5).getInitA();
															}
															initA[4]=param.getCar_list().get(4).getInitA();
										...
										initV[6]=param.getCar_list().get(6).getInitV();
									}
									initV[5]=param.getCar_list().get(5).getInitV();
								}
								initV[4]=param.getCar_list().get(4).getInitV();
						...
						for(initV[2]=param.getCar_list().get(2).getInitV();initV[2]<=param.getCar_list().get(2).getLIMIT_initV();initV[2]+=param.getCar_list().get(2).getSTEP_initV()){
							for(initV[3]=param.getCar_list().get(3).getInitV();initV[3]<=param.getCar_list().get(3).getLIMIT_initV();initV[3]+=param.getCar_list().get(3).getSTEP_initV()){
								for(initV[4]=param.getCar_list().get(4).getInitV();initV[4]<=param.getCar_list().get(4).getLIMIT_initV();initV[4]+=param.getCar_list().get(4).getSTEP_initV()){
									for(initV[5]=param.getCar_list().get(5).getInitV();initV[5]<=param.getCar_list().get(5).getLIMIT_initV();initV[5]+=param.getCar_list().get(5).getSTEP_initV()){
										for(initV[6]=param.getCar_list().get(6).getInitV();initV[6]<=param.getCar_list().get(6).getLIMIT_initV();initV[6]+=param.getCar_list().get(6).getSTEP_initV()){
											for(initV[7]=param.getCar_list().get(7).getInitV();initV[7]<=param.getCar_list().get(7).getLIMIT_initV();initV[7]+=param.getCar_list().get(7).getSTEP_initV()){
												for(initA[0]=param.getCar_list().get(0).getInitA();initA[0]<=param.getCar_list().get(0).getLIMIT_initA();initA[0]+=param.getCar_list().get(0).getSTEP_initA()){
													for(initA[1]=param.getCar_list().get(1).getInitA();initA[1]<=param.getCar_list().get(1).getLIMIT_initA();initA[1]+=param.getCar_list().get(1).getSTEP_initA()){
														for(initA[2]=param.getCar_list().get(2).getInitA();initA[2]<=param.getCar_list().get(2).getLIMIT_initA();initA[2]+=param.getCar_list().get(2).getSTEP_initA()){
															for(initA[3]=param.getCar_list().get(3).getInitA();initA[3]<=param.getCar_list().get(3).getLIMIT_initA();initA[3]+=param.getCar_list().get(3).getSTEP_initA()){
																for(initA[4]=param.getCar_list().get(4).getInitA();initA[4]<=param.getCar_list().get(4).getLIMIT_initA();initA[4]+=param.getCar_list().get(4).getSTEP_initA()){
																	for(initA[5]=param.getCar_list().get(5).getInitA();initA[5]<=param.getCar_list().get(5).getLIMIT_initA();initA[5]+=param.getCar_list().get(5).getSTEP_initA()){
																		for(initA[6]=param.getCar_list().get(6).getInitA();initA[6]<=param.getCar_list().get(6).getLIMIT_initA();initA[6]+=param.getCar_list().get(6).getSTEP_initA()){
																			for(initA[7]=param.getCar_list().get(7).getInitA();initA[7]<=param.getCar_list().get(7).getLIMIT_initA();initA[7]+=param.getCar_list().get(7).getSTEP_initA()){
																				SCRIPT+=writeCycle();
																			}
																			initA[7]=param.getCar_list().get(7).getInitA();
																		}
																		initA[6]=param.getCar_list().get(6).getInitA();
																	}
																	initA[5]=param.getCar_list().get(5).getInitA();
											...
											initV[7]=param.getCar_list().get(7).getInitV();
										}
										initV[6]=param.getCar_list().get(6).getInitV();
									}
									initV[5]=param.getCar_list().get(5).getInitV();
			...
			if(nb_car>8){
				System.out.println("Only 8 cars stand for parameters variations");
			}
	...
	public String writeCycle(){
		String part="echo \"voiture1: init_V="+initV[0]+"  init_A="+initA[0];
				for(int car=1; car<nb_car;car++){
					part+="        voiture"+car+": init_V="+initV[car]+"  init_A="+initA[car];
				}
				part+="\" >>Tests.txt\n"
				+"java -jar Generator.jar "+scale
				+" "+S
				+" "+L
				+" "+R
				+" "+V_min
